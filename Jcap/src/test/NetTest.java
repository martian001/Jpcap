...
public class NetTest {
    public static void main(String[] args) throws IOException {
        new NetTest().capturePacketsFromDevice();
    }
    ...
    public JpcapCaptor getJpcap() throws IOException {
        ...
        jpcap = JpcapCaptor.openDevice(devices[1], /*caplen*/68, /*是否设置为混杂模式*/true, 50);
        //是否使用使用过滤
        if (1 == 1) {
//            jpcap.setFilter("ip.dst==116.7.226.76", true);
    ...
    public void dealPacket(Packet packet) {
        try {
            ...
            strtmp = new String(packet.header, "utf8");
            r.addElement(strtmp); //首部内容

            strtmp = new String(packet.data, "utf8");
